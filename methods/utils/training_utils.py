...
from methods.utils.models_utils import *
...
def create_multi_2data_loaders(args,
                              train_size=None,
                              val_size=None,
                              outSize=None,
                              imgSize=None,
...
def create_multi_3data_loaders(args,
                        train_size=None,
                        val_size=None,
                        outSize=None,
                        imgSize=None,
                        ...
                        numWorkers=4):
    shuffle_opt = shuffle
    data_MIT = SaliconDataset('%s' % args.train_MIT_img_dir,
                       '%s' % args.train_MIT_gt_dir,
                       size=train_size, flip=flip, outSize=outSize, imgSize=imgSize, fxtSize=trFxtSize)
    data_art = SaliconDataset('%s' % args.train_art_img_dir,
                       '%s' % args.train_art_gt_dir,
    ...
    data_websal = SaliconDataset('%s' % args.train_websal_img_dir,
                       ...
                       size=train_size, flip=flip, outSize=outSize, imgSize=imgSize, fxtSize=trFxtSize)
    custom_sampler = None
    concat_train_dataset = ConcatDataset([data_MIT, data_art, data_websal])
    train_loader = torch.utils.data.DataLoader(
        concat_train_dataset,
        batch_size=args.batch_size,
        shuffle=shuffle_opt,
    ...
    val_MIT = SaliconDataset('%s' % args.val_MIT_img_dir,
                       '%s' % args.val_MIT_gt_dir,
                       size=val_size, outSize=outSize, imgSize=imgSize, flip=False, fxtSize=valFxtSize)
    val_art = SaliconDataset('%s' % args.val_art_img_dir,
                       '%s' % args.val_art_gt_dir,
    ...
    val_websal = SaliconDataset('%s' % args.val_websal_img_dir,
                       '%s' % args.val_websal_gt_dir,
                       size=val_size, outSize=outSize, imgSize=imgSize, flip=False, fxtSize=valFxtSize)
    concat_val_dataset = ConcatDataset([val_MIT, val_art, val_websal])
    val_loader = torch.utils.data.DataLoader(
        concat_val_dataset,
        batch_size=args.val_batch_size,
        shuffle=False,
...
def create_salicon_art_data_loaders(args,
                        train_size=None,
                        val_size=None,
                        outSize=None,
                        imgSize=None,
    ...
    #                    '%s' % args.train_MIT_gt_dir,
    #                    size=train_size, flip=flip, outSize=outSize, imgSize=imgSize, fxtSize=trFxtSize)
    data_salicon = SaliconDataset('%s' % args.train_salicon_img_dir,
                       '%s' % args.train_salicon_gt_dir,
                       size=train_size, flip=flip, outSize=outSize, imgSize=imgSize, fxtSize=trFxtSize)
    data_art = SaliconDataset('%s' % args.train_art_img_dir,
                       '%s' % args.train_art_gt_dir,
    ...
    #                    size=train_size, flip=flip, outSize=outSize, imgSize=imgSize, fxtSize=trFxtSize)
    custom_sampler = None
    concat_train_dataset = ConcatDataset([data_salicon, data_art])
    train_loader = torch.utils.data.DataLoader(
        concat_train_dataset,
        batch_size=args.batch_size,
        shuffle=shuffle_opt,
    ...
    #                    '%s' % args.val_MIT_gt_dir,
    #                    size=val_size, outSize=outSize, imgSize=imgSize, flip=False, fxtSize=valFxtSize)
    val_salicon = SaliconDataset('%s' % args.val_salicon_img_dir,
                       '%s' % args.val_salicon_gt_dir,
                       size=val_size, outSize=outSize, imgSize=imgSize, flip=False, fxtSize=valFxtSize)
    val_art = SaliconDataset('%s' % args.val_art_img_dir,
                       '%s' % args.val_art_gt_dir,
    ...
    #                    '%s' % args.val_websal_gt_dir,
    #                    size=val_size, outSize=outSize, imgSize=imgSize, flip=False, fxtSize=valFxtSize)
    concat_val_dataset = ConcatDataset([val_salicon, val_art])
    val_loader = torch.utils.data.DataLoader(
        concat_val_dataset,
        batch_size=args.val_batch_size,
        shuffle=False,
...
def create_MIT_art_data_loaders(args,
                        train_size=None,
                        val_size=None,
                        outSize=None,
                        imgSize=None,
    ...
    #                    size=train_size, flip=flip, outSize=outSize, imgSize=imgSize, fxtSize=trFxtSize)
    custom_sampler = None
    concat_train_dataset = ConcatDataset([data_MIT, data_art])
    train_loader = torch.utils.data.DataLoader(
        concat_train_dataset,
        batch_size=args.batch_size,
        shuffle=shuffle_opt,
    ...
    #                    '%s' % args.val_websal_gt_dir,
    #                    size=val_size, outSize=outSize, imgSize=imgSize, flip=False, fxtSize=valFxtSize)
    concat_val_dataset = ConcatDataset([val_MIT, val_art])
    val_loader = torch.utils.data.DataLoader(
        concat_val_dataset,
        batch_size=args.val_batch_size,
        shuffle=False,
